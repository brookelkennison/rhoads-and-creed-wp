...
class Business_Capital_Email_List_Options {
	...
	public function add_defaults( $default_options ) {
		$defaults = array(
			'business_capital_email_list_visibility' => 'disabled',
		);
	...
	public function register_options( $wp_customize ) {
		Business_Capital_Customizer_Utilities::register_option(
			array(
				'settings'          => 'business_capital_email_list_visibility',
				'type'              => 'select',
				'sanitize_callback' => 'business_capital_sanitize_select',
				'label'             => esc_html__( 'Visible On', 'business-capital' ),
				'section'           => 'business_capital_ss_email_list',
				'choices'           => Business_Capital_Customizer_Utilities::section_visibility(),
			)
		);

		// Add Edit Shortcut Icon.
		$wp_customize->selective_refresh->add_partial( 'business_capital_email_list_visibility', array(
			'selector' => '#email-list-section',
		) );
		...
		Business_Capital_Customizer_Utilities::register_option(
			array(
				...
				'settings'          => 'business_capital_email_list_page',
		...
		Business_Capital_Customizer_Utilities::register_option(
			array(
				...
				'settings'          => 'business_capital_email_list_custom_subtitle',
	...
	public function is_section_visible( $control ) {
		return ( business_capital_display_section( $control->manager->get_setting( 'business_capital_email_list_visibility' )->value() ) );
	}
}
 ...
 * Initialize class
 */
$business_capital_ss_email_list = new Business_Capital_Email_List_Options();
