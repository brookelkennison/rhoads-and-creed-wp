...
class __TwigTemplate_a5bbf8002cbed984e1ad857c1674c653 extends \MailPoetVendor\Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "newsletter/templates/blocks/header/settings.hbs", "/Applications/XAMPP/xamppfiles/htdocs/rhoades-and-creed/wp-content/plugins/mailpoet/views/newsletter/templates/blocks/header/settings.hbs");
    }
}
