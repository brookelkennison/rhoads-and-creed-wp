...
class __TwigTemplate_c67f45bbead20e35afbf49daaf7d4273 extends \MailPoetVendor\Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "newsletter/templates/blocks/spacer/settings.hbs", "/Applications/XAMPP/xamppfiles/htdocs/rhoades-and-creed/wp-content/plugins/mailpoet/views/newsletter/templates/blocks/spacer/settings.hbs");
    }
}
